...
# ISO 3166-1 alpha-3 -> alpha-2, for every code in `ISO3166_ALPHA3` (the two are pinned equal by
# test). Universal data, not a preference: it is how a search host that takes a two-letter
# country (Indeed's `co=`) is addressed from a profile's alpha-3 `target_countries`.
ISO3166_ALPHA2 = dict(
