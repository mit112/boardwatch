...
inside the closure the tailor/bundle import-wall test walks. A type defined in the projection
package would drag the canonical-bundle package into that closure and break the wall. `core`
imports neither, and a test alongside this module pins that it stays that way.
