...
def test_the_markdown_reports_every_catalog_rule_including_those_that_never_fired() -> None:
    ...
    assert len(ids) == 65  # 64 -> 65: the `scoped_years_preferred` carrier (T173); 62 -> 64: the two domain range twins (T200); 60 -> 62: the two ceiling twins (T178, 2026-09-24); 57 -> 59: the two months patterns (2026-09-04); 59 -> 60: `labeled_years_minimum` (2026-09-05)
    for rule_id in ids:
