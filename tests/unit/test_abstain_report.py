...
def test_every_catalog_rule_appears_even_with_no_rows() -> None:
    ...
    assert len(report.rules) == 64  # 57 -> 59: the two months patterns (2026-09-04); 59 -> 60: `labeled_years_minimum` (2026-09-05); 60 -> 62: the two T178 ceilings; 62 -> 64: the two T200 domain range twins
...
def test_never_fired_is_not_counted_as_fully_abstaining() -> None:
    ...
    assert len(report.never_fired) == 64  # 57 -> 59: the two months patterns (2026-09-04); 59 -> 60: `labeled_years_minimum` (2026-09-05); 60 -> 62: the two T178 ceilings; 62 -> 64: the two T200 domain range twins
