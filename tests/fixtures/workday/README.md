...
| `list_censored_with_facets.json` | `total: 2000` (the censor value) with three facet dimensions summing to 3000+1589=4589, 4589, and 0 — pins that `_uncapped_total` takes the largest non-zero dimension, not the first or the sum of all (D-271). |
