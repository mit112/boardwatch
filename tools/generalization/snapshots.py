...
EXPECTED_SETTINGS_DEFAULTS: dict[str, object] = {
    ...
    "Settings.jobapps_queue_dir": None,
...
SETTINGS_FIELD_CLASS: dict[str, str] = {
    ...
    "Settings.fetch_deadline_seconds": "operational",
...
EXPECTED_INIT_PROMPTS: tuple[tuple[str, str, str | None], ...] = (
    ...
    # `field_of_study` prompt below is a single catalog-scalar, likewise constant as its
    # vocabulary grows.
