...
SHIPPED_DATA: dict[str, DataEntry] = {
    ...
    "src/boardwatch/eligibility/rules.yaml": DataEntry(
        ...
        pin="sha256:b1f54e0023dbaa8c9e445f8c8981d77f778354d7ed424964ad6bd5a7e69d9988",
    ),
    ...
    "tests/fixtures/workday/list_facet_catalog_underscored.json": DataEntry(
        kind="fixture",
        reason=_FIXTURE,
        pin="sha256:673e5a45d7f217f7b2ca14c6a5dcf703613031cb01158b56d0ae516cb2c34725",
    ),
